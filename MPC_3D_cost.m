function [xtot, utot] = MPC_3D_cost(init,params,pred,CWH)
...
% the params structure. Constraints are implemented as soft by adding a
% term to the cost function that penalizes being outside the cone
